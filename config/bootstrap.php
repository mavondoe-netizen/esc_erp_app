...
/*
 * Globally inject AuditLogBehavior into every Table dynamically
 */
\Cake\Event\EventManager::instance()->on('Model.initialize', function (\Cake\Event\EventInterface $event) {

...
class ContractsController extends AppController
{
    ...
    {
        $contract = $this->Contracts->get($id, contain: ['Awards', 'Companies', 'GoodsReceipts']);
    ...
    public function add()
    {
        ...
        $awards = $this->Contracts->Awards->find('list', limit: 200)->all();
        $companies = $this->Contracts->Companies->find('list', limit: 200)->all();
        $this->set(compact('contract', 'awards', 'companies'));
    }

...
class EmailsController extends AppController
{
    ...
    {
        $email = $this->Emails->get($id, contain: ['Contacts', 'Companies']);
    ...
    public function add()
    {
        ...
        $contacts = $this->Emails->Contacts->find('list', limit: 200)->all();
        $companies = $this->Emails->Companies->find('list', limit: 200)->all();
        $this->set(compact('email', 'contacts', 'companies'));
    }

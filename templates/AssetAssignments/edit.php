...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $assetAssignment->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $assetAssignment->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="assetAssignments form content">
            ...
            <fieldset>
                <legend><?= __('Edit Asset Assignment') ?></legend>
                <?php

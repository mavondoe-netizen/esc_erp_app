...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $employeeProfile->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $employeeProfile->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="employeeProfiles form content">
            ...
            <fieldset>
                <legend><?= __('Edit Employee Profile') ?></legend>
                <?php

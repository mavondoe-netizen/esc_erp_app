...
<script>
    ...
    function addRow() {
        ...
        let productHtml = `<select name="debit_note_items[${rowIndex}][product_id]" onchange="updateProduct(${rowIndex}, this.value)" class="form-control"><option value="">Custom/Other</option>`;
        ...
        tr.innerHTML = `
            <td>${productHtml}</td>
            <td>${accountHtml}</td>
            <td><input type="number" name="debit_note_items[${rowIndex}][quantity]" id="qty-${rowIndex}" step="1" value="1" onchange="calculateLine(${rowIndex})" class="form-control"></td>
            <td><input type="number" name="debit_note_items[${rowIndex}][unit_price]" id="price-${rowIndex}" step="0.01" value="0.00" onchange="calculateLine(${rowIndex})" class="form-control"></td>
            <td><input type="number" name="debit_note_items[${rowIndex}][vat_rate]" id="vat-rate-${rowIndex}" step="0.01" value="0.00" onchange="calculateLine(${rowIndex})" class="form-control"></td>
            <td><input type="number" name="debit_note_items[${rowIndex}][vat_amount]" id="vat-amount-${rowIndex}" step="0.01" value="0.00" readonly class="form-control" style="background: #f8fafc; border: none;"></td>
            <td><input type="number" name="debit_note_items[${rowIndex}][line_total]" id="total-${rowIndex}" step="0.01" value="0.00" readonly class="form-control" style="background: #f8fafc; border: none; font-weight: 600;"></td>

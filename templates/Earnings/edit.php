    ...
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete # {0}?', $earning->id), 'class' => 'side-nav-item']
            ) ?>
        ...
        <div class="earnings form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo '<div class="column column-33">' . $this->Form->control('taxable_percentage', ['type' => 'number', 'step' => '0.01', 'label' => 'Taxable Percentage (%)']) . '</div>';
                    echo '<div class="column column-33">' . $this->Form->control('tax_free_amount', ['type' => 'number', 'step' => '0.01', 'label' => 'Tax-Free Threshold (Fixed Amt)']) . '</div>';
                    echo '</div>';
                ?>
            </fieldset>

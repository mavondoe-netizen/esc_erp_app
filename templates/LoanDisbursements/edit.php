...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $loanDisbursement->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $loanDisbursement->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="loanDisbursements form content">
            ...
            <fieldset>
                <legend><?= __('Edit Loan Disbursement') ?></legend>
                <?php

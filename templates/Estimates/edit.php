...
<script>
    ...
    function addRow(data = null) {
        ...
        productHtml += `<select name="estimate_items[${rowIndex}][product_id]" onchange="updateProduct(${rowIndex}, this.value)" class="form-control"><option value="">Custom/Other</option>`;

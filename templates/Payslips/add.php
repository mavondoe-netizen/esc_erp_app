        ...
        <div class="payslips form content">
            ...
            <fieldset>
                ...
                <div class="row" style="margin-bottom: 20px;">
                    <div class="column column-33">
                        <?= $this->Form->control('exchange_rate', ['type' => 'number', 'step' => '0.0001', 'id' => 'exchange-rate', 'default' => 1.0, 'class' => 'form-control']) ?>
                    </div>
                </div>
...
<script>
    ...
    function calculateGrandTotal() {
        ...
        let nssa = 0; let pension = 0; let paye = 0; let aidsLevy = 0;
        ...
        rows.forEach(row => {
            ...
            if (type === 'Earning') {
                ...
                if (name.includes('NSSA')) nssa += amt;
                if (name.includes('Pension')) pension += amt;
                if (name.includes('PAYE')) paye += amt;
                if (name.includes('Aids Levy')) aidsLevy += amt;
            }
        });

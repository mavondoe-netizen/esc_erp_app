...
<script>
    ...
    function addRow(data = null) {
        ...
        tr.innerHTML = `
            ...
            <td><input type="number" name="bill_items[${rowIndex}][line_total]" id="total-${rowIndex}" step="0.01" value="${lineTotal}" readonly class="form-control" style="background: #f8fafc; border: none; font-weight: 600;"></td>

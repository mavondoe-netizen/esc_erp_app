        ...
        <div class="payPeriods form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo '<div class="row">';
                    echo '<div class="column column-50">' . $this->Form->control('month', ['options' => $months, 'default' => date('m')]) . '</div>';
                    echo '<div class="column column-50">' . $this->Form->control('year', ['options' => $years, 'default' => $currentYear]) . '</div>';
                    echo '</div>';
                    
                    echo $this->Form->control('status', ['options' => ['Current' => 'Current (Active)', 'Previous' => 'Previous (Closed)'], 'default' => 'Current']);
                ?>
            </fieldset>
